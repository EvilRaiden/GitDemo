	...
	int choise = s.nextInt();
		...
		switch(choise){
			case 1:
				...
				System.out.println("Enter the color of your shape");//displays an output to the user to tempt the user to enter a color
				...
				switch (choise2){
					...
					case 2:
						...
						Rectangle r = new Rectangle(width,height,colour, filled);
						this.addShape(r);
						break;
					case 3:
